    ...
    <div id="cmpopfly-options-group-accortion">
        ...
        <div id="cmpopfly-options-group-tabs">
            ...
            <div id="cmpopfly-tab-basic-visual" class="options-tab hidden">
				...
				<label class="onlyinpro">Fly-In Bottom (Position)</label>
                <p class="onlyinpro">
				...
				<label class="onlyinpro">Advertisement items rotating time in Fly-In Bottom</label>
                <p class="onlyinpro">
                ...
                <label class="onlyinpro">Display method</label>
                <p class="onlyinpro">
                ...
                <p>
                    ...
                    <span class='field-info'><span>(Only in Pro)</span> The 'z-index' of the banner. If you find that the banner is under other elements, increase this value. If blank defaults to 100. Please input an integer value (0-10000000000).</span>
                </p>
                ...
                <label class="onlyinpro">Shape</label>
                <p class="onlyinpro">
            ...
            <div id="cmpopfly-tab-advanced-visual" class="options-tab hidden">
                ...
                <span id="underlayTypeContainer" style="display: none;">
                    <label class="onlyinpro">Underlay type</label>
                    <p class="onlyinpro">
                        ...
                        <span class='field-info'><span>(Only in Pro)</span> You can choose the different underlay type for current campaign.</span>
                    </p>
                </span>
				
                <label class="onlyinpro">Statistics clicks counting method</label>				
                <p class="onlyinpro">
                    <?php
            ...
            <div id="cmpopfly-tab-sound" class="options-tab hidden">
				...
				<label class="onlyinpro">Sound effect when popup shows</label>
                <p class="onlyinpro">
                    <?php
