...
* Added restriction so that only admin user able to see preview of popup campaign
...
= 1.8.1 =
* Bugfix related to popup load with specific post/page
...
* Fixed fatal error related to get_current_user() function
